/* Produced by CVXGEN, 2016-05-03 19:36:34 -0400.  */
...
#ifndef GENSOLVERSECOND_H
#define GENSOLVERSECOND_H
#include <array>
#include <ctime>
#include <cstdlib>
...
public:
GensolverSecond( int, double, double, double, double, double,  double, double, double, double ); // Gensolver object constructor
~GensolverSecond(); // Gensolver object destructor
