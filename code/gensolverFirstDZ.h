...
#ifndef GENSOLVERFIRSTDZ_H
#define GENSOLVERFIRSTDZ_H
#include <array>
#include <ctime>
#include <cstdlib>
...
public:
GensolverFirstDZ( int, double, double, double, double, double, double, double, double, double, double, double); // Gensolver object constructor
~GensolverFirstDZ(); // Gensolver object destructor
