...
public:
	Network( int, int, int, int, int, int, int, int, int, int, int, int ); // constructor
	~Network(); // destructor
...
private:
	...
	int postContScenario; // ID number of the post-contingency scenario for last interval, corresponding to which the network instance is generated, 0 for base case
	...
	int dummyZ; // Indicates whether a dummy zero interval before the forthcoming is considered or not, 0 for no, 1 for yes
	int Accuracy; // Indicates the level of accuracy of the contingency scenario solvers 0 for simple, 1 for complete/extended/more accurate
	...
	int baseOutagedLine; // Line that is supposedly outaged in the post-contingency cases for the basenetwork: 0 for no assumed outage
	...
	double pSelfBuffer[1000]; // Buffer for the generator MW output of the generators in this coarse grain from the previous APP iteration
	double pPrevBuffer[1000]; // Buffer for the generator MW output of the generators in this coarse grain from the previous APP iteration
	double pNextBuffer[1000]; // Buffer for the generator MW output of the generators in this coarse grain from the previous APP iteration
	double pSelfBufferGUROBI[1000]; // Buffer for the generator MW output of the generators in this coarse grain from the previous APP iteration
	double pNextBufferGUROBI[1000]; // Buffer for the generator MW output of the generators in next coarse grain from the previous APP iteration
	double pPrevBufferGUROBI[1000]; // Buffer for the generator MW output of the generators in previous coarse grain from the previous APP iteration
