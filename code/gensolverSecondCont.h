...
#ifndef GENSOLVERSECONDCONT_H
#define GENSOLVERSECONDCONT_H
#include <array>
#include <ctime>
#include <cstdlib>
...
public:
GensolverSecondCont( int, double, double, double, double, double, double, double, double, double, double, double, int ); // Gensolver object constructor
~GensolverSecondCont(); // Gensolver object destructor
