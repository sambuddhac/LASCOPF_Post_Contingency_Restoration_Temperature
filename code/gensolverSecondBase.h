...
#ifndef GENSOLVERSECONDBASE_H
#define GENSOLVERSECONDBASE_H
#include <array>
#include <ctime>
#include <cstdlib>
...
public:
GensolverSecondBase( int, double, double, double, double, double, double, double, double, double, double, double, int); // Gensolver object constructor
~GensolverSecondBase(); // Gensolver object destructor
