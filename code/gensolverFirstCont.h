/* Produced by CVXGEN, 2019-02-10 21:14:19 -0500.  */
...
#ifndef GENSOLVERFIRSTCONT_H
#define GENSOLVERFIRSTCONT_H
#include <array>
#include <ctime>
#include <cstdlib>
...
public:
GensolverFirstCont( int, double, double, double, double, double, double, double, double, double, double, double); // Gensolver object constructor
~GensolverFirstCont(); // Gensolver object destructor
...
void mainsolve(double, double, double, double, double, double, double, double, double, double[], double[], double[], double[], double[], double, double);
void load_default_data(double, double, double, double, double, double, double, double, double, double[], double[], double[], double[], double[], double, double);
double getPSol(void);
